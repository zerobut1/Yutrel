...
namespace Yutrel
{
    void VulkanPipeline::Init(RenderPipelineInitInfo info)
    {
        ...
        main_init_info.directional_light_shadowmap = std::static_pointer_cast<DirectionalLightPass>(m_directional_light_pass)->m_depth_image;
        main_init_info.shadowmap_sampler           = std::static_pointer_cast<DirectionalLightPass>(m_directional_light_pass)->m_depth_sampler;
