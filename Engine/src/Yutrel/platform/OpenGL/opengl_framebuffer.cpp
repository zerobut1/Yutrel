    ...
    void OpenGLFramebuffer::Invalidate()
    {
        ...
        if (m_ColorAttachmentSpecifications.size())
        {
            ...
            for (size_t i = 0; i < m_ColorAttachments.size(); i++)
            {
                ...
                case FramebufferTextureFormat::DEPTH32:
                    Utils::AttachColorTexture(m_ColorAttachments[i], m_Specification.Samples, GL_DEPTH_COMPONENT, GL_DEPTH_COMPONENT, m_Specification.Width, m_Specification.Height, i);
                    break;
        ...
        if (m_DepthAttachmentSpecification.TextureFormat != FramebufferTextureFormat::None)
        {
            ...
            /*
                            case FramebufferTextureFormat::DEPTH32:
                            Utils::AttachDepthTexture(m_DepthAttachment, m_Specification.Samples, GL_DEPTH_ATTACHMENT, GL_DEPTH_ATTACHMENT, m_Specification.Width, m_Specification.Height);
                            break;
*/
            default:
                break;
